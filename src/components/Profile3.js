...
class Profile3 extends Component {
    ...
    componentDidMount() {
      this.props.fetchRepos3();
    }

    UNSAFE_componentWillReceiveProps(nextProps) {
      this.setState({userInfo: nextProps.profile3, editing: false, error: false})
    }  
      ...
      saveProfile3() {
        ...
        if(!error) {
          this.props.saveProfile3(this.state.userInfo);
        }
        this.setState({error});
      }
    ...
    <div className="container">
      ...
      {this.state.editing ? 
        <Form.Group>
          ...
          />
          <br />
          <Button variant="dark" onClick={this.saveProfile3.bind(this)}>Save</Button>
        </Form.Group>
      : 
        <div>
